...
void WebRendererSchemeHandler::ProcessRequestInternal(CefRefPtr<CefRequest> p_Request, CefRefPtr<CefCallback> p_Callback)
{
	...
	if (s_Host == "game")
	{
		// Custom game hosting page.
		if (s_FinalPath == "/index.html")
		{
			// Disallow accessing the main page from other frames.
			if (!m_Main)
			{
				p_Callback->Cancel();
				return;
			...
			m_TempData = "<!DOCTYPE html><html lang=en><head><meta charset=utf-8><title></title><style type=text/css>body,html{padding:0;margin:0;background:0 0;width:100%;height:100%;overflow:hidden}#frame-hell{position:absolute;top:0;right:0;bottom:0;left:0;margin:0;padding:0;width:100%;height:100%;overflow:hidden}#frame-hell iframe{position:absolute;top:0;right:0;bottom:0;left:0;margin:0;padding:0;background:0 0;width:100%;height:100%;border:0;display:block}</style><body><div id=frame-hell></div><script type=text/javascript>window.AddFrame=function(e){if(\"frame-hell\"!=e&&\"main\"!=e&&null==document.getElementById(e)){var t=document.createElement(\"iframe\");t.setAttribute(\"src\",\"vu://\"+e+\"/\"),t.setAttribute(\"id\",e),t.setAttribute(\"sandbox\",\"allow-forms allow-pointer-lock allow-scripts\");var n=document.getElementById(\"frame-hell\");t.setAttribute(\"data-index\",n.childNodes.length.toString()),t.style[\"z-index\"]=n.childNodes.length.toString(),n.appendChild(t)}},window.RemoveFrame=function(e){var t=document.getElementById(e);null!=t&&(BringToFront(e),t.parentElement.removeChild(t))},window.HideFrame=function(e){var t=document.getElementById(e);null!=t&&(t.style.display=\"none\")},window.ShowFrame=function(e){var t=document.getElementById(e);null!=t&&(t.style.display=\"block\")},window.BringToFront=function(e){var t=document.getElementById(e);if(null!=t){for(var n=parseInt(t.getAttribute(\"data-index\"),10),l=n,d=document.getElementById(\"frame-hell\"),i=n+1;i<d.childNodes.length;++i){var o=document.querySelectorAll('[data-index=\"'+i+'\"]');if(0==o.length)break;l=i;var r=i-1;o[0].setAttribute(\"data-index\",r.toString()),o[0].style[\"z-index\"]=r.toString()}t.setAttribute(\"data-index\",l.toString()),t.style[\"z-index\"]=l.toString()}},window.InjectJS=function(e,t){var n=document.getElementById(e);null!=n&&n.contentWindow.postMessage(t,\"*\")};</script>";
		}
		else if (s_FinalPath == "/common.css")
		{
			m_TempData = "";
		}
