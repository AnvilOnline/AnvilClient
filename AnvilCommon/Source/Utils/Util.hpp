...
namespace AnvilCommon::Utils
{
	...
	public:
		...
		static bool PatchAddressInMemory(size_t p_Offset, std::string p_HexString, int32_t p_Length);
		static bool PatchAddressInMemory(void* p_Address, std::string p_HexString, int32_t p_Length);
		static bool PatchAddressInFile(size_t p_Offset, std::string p_HexString, int32_t p_Length);
