...
namespace Blam::Tags::Items
{
	...
	using Blam::Game::DamageReportingType;
	...
	struct Weapon : Item
	{
		...
		struct Weapon::TargetTracking
		{
			...
			static_assert(sizeof(struct Weapon::TargetTracking::TrackingType) == 0x4, "");
		};
		static_assert(sizeof(struct Weapon::TargetTracking) == 0x38, "");
		...
		static_assert(sizeof(struct Weapon::FirstPersonResources) == 0x20, "");
		...
		static_assert(sizeof(struct Weapon::PredictedResource) == 0x8, "");
		...
		struct Weapon::Magazine
		{
			...
			static_assert(sizeof(struct Weapon::Magazine::Equipment) == 0x14, "");
		};
		static_assert(sizeof(struct Weapon::Magazine) == 0x80, "");
		...
		static_assert(sizeof(struct Trigger) == 0x90, "");
		...
		struct Barrel
		{
			...
			static_assert(sizeof(struct Weapon::Barrel::Function) == 0x14, "");

			struct Weapon::Barrel::FirstPersonOffset
			{
				RealPoint3D Offset;
			};
			static_assert(sizeof(struct Weapon::Barrel::FirstPersonOffset) == 0xC, "");
			...
			static_assert(sizeof(struct Weapon::Barrel::FiringEffects) == 0xC4, "");
		};
