	...
	namespace Tags
	{
		namespace Game
		{
			...
			struct Globals
			{
				...
				static_assert(sizeof(struct Globals::HavokCleanupResource) == 0x10, "");
				...
				static_assert(sizeof(struct Globals::SoundGlobal) == 0x60, "");
				...
				struct Globals::AIGlobal
				{
					...
					static_assert(sizeof(struct Globals::AIGlobal::GravemindProperty) == 0xC, "");

					struct Globals::AIGlobal::Style
					{
						TagReference Reference;
					};
					static_assert(sizeof(struct Globals::AIGlobal::Style) == 0x10, "");
				};
				static_assert(sizeof(struct Globals::AIGlobal) == 0x144, "");
				...
				struct Globals::DamageTable
				{
					...
					struct Globals::DamageTable::DamageGroup
					{
						...
						static_assert(sizeof(struct Globals::DamageTable::DamageGroup::ArmorModifier) == 0x8, "");
					};
					static_assert(sizeof(struct Globals::DamageTable::DamageGroup) == 0x10, "");
				};
				static_assert(sizeof(struct DamageTable) == 0xC, "");

				struct Globals::Sound
				{
					TagReference Reference; // Obsolete
				};
				static_assert(sizeof(struct Globals::Sound) == 0x10, "");
				...
				static_assert(sizeof(struct Globals::Camera) == 0xA4, "");
				...
				struct Globals::PlayerControl
				{
					...
					static_assert(sizeof(struct Globals::PlayerControl::LookFunction) == 0x4, "");
				};
				static_assert(sizeof(struct Globals::PlayerControl) == 0x70, "");
				...
				static_assert(sizeof(struct Globals::Difficulty) == 0x284, "");
				...
				static_assert(sizeof(struct Grenade) == 0x44, "");
				...
				struct Globals::InterfaceTag
				{
					...
					static_assert(sizeof(struct Globals::InterfaceTag::UIString) == 0x30, "");
				};
				static_assert(sizeof(struct Globals::InterfaceTag) == 0x12C, "");
				...
				static_assert(sizeof(struct Globals::PlayerInformation) == 0xCC, "");
				...
				static_assert(sizeof(struct PlayerRepresentation) == 0x6C, "");
				...
				static_assert(sizeof(struct Globals::PlayerFallingDamage) == 0x78, "");
				...
				static_assert(sizeof(struct Globals::Unknown59) == 0xC, "");
				...
				struct Globals::Material
				{
					...
					static_assert(sizeof(struct Globals::Material::WaterDragProperty) == 0x28, "");
					...
					static_assert(sizeof(struct Globals::Material::WaterInteraction) == 0xC, "");
				};
				static_assert(sizeof(struct Globals::Material) == 0x178, "");
				...
				static_assert(sizeof(struct Globals::CinematicAnchor) == 0x18, "");
				...
				struct Globals::MetagameGlobal
				{
					...
					static_assert(sizeof(struct Globals::MetagameGlobal::Medal) == 0x10, "");

					struct Globals::MetagameGlobal::Difficulty
					{
						float Multiplier;
					};
					static_assert(sizeof(struct Globals::MetagameGlobal::Difficulty) == 0x4, "");

					struct Globals::MetagameGlobal::PrimarySkull
					{
						float Multiplier;
					};
					static_assert(sizeof(struct Globals::MetagameGlobal::PrimarySkull) == 0x4, "");

					struct Globals::MetagameGlobal::SecondarySkull
					{
						float Multiplier;
					};
					static_assert(sizeof(struct Globals::MetagameGlobal::SecondarySkull) == 0x4, "");
				};
				static_assert(sizeof(struct Globals::MetagameGlobal) == 0x98, "");
				...
				static_assert(sizeof(struct Globals::DamageReportingType) == 0x24, "");
			};
			static_assert(sizeof(struct Globals) == 0x608, "");
		}
	}
}
#pragma once
