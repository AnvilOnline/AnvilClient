			...
			struct MultiplayerGlobals
			{
				...
				struct MultiplayerGlobals::Universal
				{
					...
					struct MultiplayerGlobals::Universal::ArmorCustomization
					{
						...
						static_assert(sizeof(struct MultiplayerGlobals::Universal::ArmorCustomization::Permutation) == 0x30, "");
					};
					static_assert(sizeof(struct MultiplayerGlobals::Universal::ArmorCustomization) == 0x14, "");
					...
					static_assert(sizeof(struct MultiplayerGlobals::Universal::GameEquipment) == 0x18, "");
					...
					static_assert(sizeof(struct MultiplayerGlobals::Universal::Unknown) == 0x8, "");
					...
					static_assert(sizeof(struct MultiplayerGlobals::Universal::GameVariantWeapon) == 0x18, "");
					...
					static_assert(sizeof(struct MultiplayerGlobals::Universal::GameVariantVehicle) == 0x14, "");
					...
					static_assert(sizeof(struct MultiplayerGlobals::Universal::GameVariantEquipment) == 0x14, "");
					...
					struct MultiplayerGlobals::Universal::WeaponSet
					{
						...
						static_assert(sizeof(struct MultiplayerGlobals::Universal::WeaponSet::Substitution) == 0x8, "");
					};
					static_assert(sizeof(struct MultiplayerGlobals::Universal::WeaponSet) == 0x10, "");
					...
					struct MultiplayerGlobals::Universal::VehicleSet
					{
						...
						static_assert(sizeof(struct MultiplayerGlobals::Universal::VehicleSet::Substitution) == 0x8, "");
					};
					static_assert(sizeof(struct MultiplayerGlobals::Universal::VehicleSet) == 0x10, "");
					...
					struct MultiplayerGlobals::Universal::PodiumAnimation
					{
						...
						static_assert(sizeof(struct MultiplayerGlobals::Universal::PodiumAnimation::Stance) == 0x34, "");
						...
						static_assert(sizeof(struct MultiplayerGlobals::Universal::PodiumAnimation::Alternates) == 0x50, "");
					};
					static_assert(sizeof(struct MultiplayerGlobals::Universal::PodiumAnimation) == 0x30, "");
				};
				static_assert(sizeof(struct MultiplayerGlobals::Universal) == 0xD8, "");
				...
				struct MultiplayerGlobals::Runtime
				{
					...
					static_assert(sizeof(struct MultiplayerGlobals::Runtime::SoundReference) == 0x10, "");

					struct MultiplayerGlobals::Runtime::LoopingSoundReference
					{
						TagReference LoopingSound;
					};
					static_assert(sizeof(struct MultiplayerGlobals::Runtime::LoopingSoundReference) == 0x10, "");
					...
					static_assert(sizeof(struct MultiplayerGlobals::Runtime::Event) == 0x10C, "");
					...
					struct MultiplayerGlobals::Runtime::MultiplayerConstant
					{
						...
						static_assert(sizeof(struct MultiplayerGlobals::Runtime::MultiplayerConstant::GameWeapon) == 0x20, "");
						...
						static_assert(sizeof(struct MultiplayerGlobals::Runtime::MultiplayerConstant::GameVehicle) == 0x20, "");
						...
						static_assert(sizeof(struct MultiplayerGlobals::Runtime::MultiplayerConstant::GameProjectile) == 0x1C, "");
						...
						static_assert(sizeof(struct MultiplayerGlobals::Runtime::MultiplayerConstant::GameEquipment) == 0x14, "");
					};
					static_assert(sizeof(struct MultiplayerGlobals::Runtime::MultiplayerConstant) == 0x220, "");
					...
					static_assert(sizeof(struct MultiplayerGlobals::Runtime::StateResponse) == 0x24, "");
				};
				static_assert(sizeof(struct MultiplayerGlobals::Runtime) == 0x2A8, "");
			};
			static_assert(sizeof(struct MultiplayerGlobals) == 0x18, "");
		}
	}
}
