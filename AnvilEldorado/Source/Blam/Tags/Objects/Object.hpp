...
namespace Blam::Tags::Objects
{
	...
	struct Object
	{
		...
		static_assert(sizeof(Object::EarlyMoverProperty) == 0x28, "");
		...
		static_assert(sizeof(Object::AIProperty) == 0xC, "");
		...
		static_assert(sizeof(Object::Function) == 0x2C, "");
		...
		static_assert(sizeof(Object::Attachment) == 0x24, "");

		struct Object::Widget
		{
			TagReference Type;
		};
		static_assert(sizeof(Object::Widget) == 0x10, "");
		...
		struct Object::ChangeColor
		{
			...
			static_assert(sizeof(Object::ChangeColor::InitialPermutation) == 0x20, "");
			...
			static_assert(sizeof(Object::ChangeColor::Function) == 0x24, "");
		};
		static_assert(sizeof(Object::ChangeColor) == 0x18, "");

		struct Object::NodeMap
		{
			int8_t TargetNode;
		};
		static_assert(sizeof(Object::NodeMap) == 0x1, "");
		...
		static_assert(sizeof(Object::MultiplayerProperty) == 0xC4, "");
		...
		static_assert(sizeof(Object::ModelObjectDatum) == 0x14, "");
	};
	static_assert(sizeof(Object) == 0x120, "");
}