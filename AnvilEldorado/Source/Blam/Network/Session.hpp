...
namespace Blam::Network
{
	...
	typedef void(*SerializePacketFn)(Data::BitStream *stream, int packetSize, const void *packet);
	typedef bool(*DeserializePacketFn)(Data::BitStream *stream, int packetSize, void *packet);
